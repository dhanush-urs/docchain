  ...
  return (
    <header className="border-b border-white/10 bg-background/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        <Link 
          href="/" 
          className="flex items-center font-extrabold text-xl sm:text-2xl md:text-3xl lg:text-4xl tracking-tight transition-transform hover:scale-105 mr-4"
        >
          <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 text-transparent bg-clip-text drop-shadow-[0_0_8px_rgba(99,102,241,0.5)] whitespace-nowrap">
            CodeIS Task Tracker
          </span>
        </Link>
